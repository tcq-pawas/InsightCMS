...
urlpatterns = [
    ...
    path('dashboard/blogs/create/', dashboard_blog_create, name='dashboard_blog_create'),
    path('dashboard/blogs/<int:page_id>/edit/', dashboard_blog_edit, name='dashboard_blog_edit'),
    path('dashboard/blogs/<int:page_id>/toggle-publish/', dashboard_blog_toggle_publish, name='dashboard_blog_toggle_publish'),
    path('dashboard/blogs/<int:page_id>/delete/', dashboard_blog_delete, name='dashboard_blog_delete'),
]