...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000, http://127.0.0.1:5500,http://localhost:5500',
...
# Increase upload and request body limits for rich text images (50 MB)
